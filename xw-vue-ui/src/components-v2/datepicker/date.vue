...
<template>
    <div class="form-item">
        ...
        >
        <div
            class="form-item-div dataPicker"
    ...
    methods: {
        ...
        getFullData(year, month) {
            ...
            for (let i = prevDaylen; i > 0; i--) {
                allData.push({
                    year: prevMonthDays.year,
                    month: prevMonthDays.month,
                    day: prevMonthDays.days - i + 1,
                    cls: "disable",
                });
            }
        ...
        selectItem(x) {
            ...
            this.selectDay =
                x.year + this.splitStr + x.month + this.splitStr + x.day;
            if (this.isDatetimePicker == undefined) {
                this.isShowPicker = false;
            }
